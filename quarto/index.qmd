...
**Progresión natural:**
1. **Definición** → Permutaciones $(\sigma, \rho)$
2. **Algoritmo** → Calcular caras con $\varphi = \rho\sigma$
3. **Invariantes** → Extraer χ, g, componentes de frontera
4. **Teoría** → Correspondencia biunívoca (Heffter-Edmonds)
5. **Aplicaciones** → Operaciones y polinomios
