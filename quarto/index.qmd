...
### [6. Operaciones y Polinomio de Bollobás-Riordan](capitulos/06-recursividad.qmd)

Operaciones sobre ribbon graphs e invariantes polinomiales del encaje.

- Contracción de aristas: fusión de vértices con preservación del género
- Dualidad: intercambio de vértices y caras ($V^*=F$, $F^*=V$, $g^*=g$)
- Base de homología y la fórmula $\mathrm{rank}(H_1) = 2g + b - 1$
- Polinomio de Bollobás-Riordan: generalización del polinomio de Tutte a superficies
- Implementación correcta vía suma sobre subgrafos y verificación interactiva
