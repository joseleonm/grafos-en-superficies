...
- Obtener invariantes topológicos: género, característica de Euler, número de caras
...
### [2. Mapas Combinatorios](capitulos/02-mapas-combinatorios.qmd)
...
### [4. Equivalencia](capitulos/04-teorema.qmd)

El teorema fundamental que establece la correspondencia biunívoca.

- Lectura del encaje: obtención de $(\sigma,\rho)$ desde un dibujo encajado
- Teorema de Heffter‑Edmonds y equivalencia por conjugación
- Verificación en SageMathCell del género en ejemplos concretos
- Ejemplos de encajes equivalentes y no equivalentes (criterio por caras)
- Teorema de Whitney, Steinitz y conectividad 3‑conexa
- Orientabilidad y limitaciones del modelo

### [5. Ejemplos](capitulos/05-ejemplos.qmd)

Verificación computacional de equivalencia entre sistemas de rotación.

- Ejemplo ilustrativo: el moño y el ojo son equivalentes pese a la intuición
- Ejemplo de no-equivalencia: multiconjuntos de caras como invariante rápido
- Del problema al algoritmo: fuerza bruta vs. búsqueda con retroceso
- Diagramas de Heegaard de la Esfera de Poincaré como encajes celulares
- Verificación interactiva con SageMathCell

### [6. Operaciones sobre Ribbon Graphs](capitulos/06-operaciones.qmd)

Operaciones fundamentales para transformar y analizar ribbon graphs en Sage.

- Contracción de aristas: fusión de vértices preservando el género.
- Dualidad: intercambio de vértices y caras ($V^*=F$, $F^*=V$).
- Base de homología y cálculo del rango $\mathrm{rank}(H_1) = 2g + b - 1$.
- Reducción: obtención del núcleo de Betti contrayendo árboles generadores.

### [7. Polinomio de Bollobás-Riordan](capitulos/07-bollobas-riordan.qmd)

Generalización del polinomio de Tutte que detecta la topología del encaje.

- Definición, cálculo y optimización en Sage.
- La variable $z$ como detector del género.
- Distinción de encajes mediante el polinomio.

### [8. BR del Diagrama de Poincaré](capitulos/08-br-diagrama-poincare.qmd)

Cálculo computacional del polinomio para un caso de alta complejidad ($E=24$).

- Sistema de rotación del diagrama de Heegaard ($V=12, E=24$).
- Resultado explícito del polinomio $R(G; x, y, z)$.
